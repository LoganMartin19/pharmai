...
export const PHARMACY_SERVICE_META: Record<PharmacyServiceId, { label: string; icon: string }> = {
  prescription_refill: { label: 'Refills', icon: '💊' },
  pharmacy_first: { label: 'Pharmacy First', icon: '🩺' },
  contraceptive_pill: { label: 'Contraceptive pill', icon: '💊' },
  emergency_contraception: { label: 'Emergency contraception', icon: '🌸' },
  blood_pressure: { label: 'Blood pressure', icon: '❤️' },
  flu_vaccine: { label: 'Flu vaccine', icon: '💉' },
  covid_tests: { label: 'COVID tests', icon: '🧪' },
  new_medicine_service: { label: 'New Medicine Service', icon: '💬' },
  medicines_care_review: { label: 'Medicines Care Review', icon: '📋' },
  medicine_disposal: { label: 'Medicine disposal', icon: '♻️' },
  weight_management: { label: 'Weight management', icon: '⚖️' },
  stop_smoking: { label: 'Stop smoking', icon: '🌱' },
  chlamydia: { label: 'Chlamydia service', icon: '🧬' },
  cholesterol_blood_sugar: { label: 'Cholesterol/blood sugar', icon: '🩸' },
  substance_misuse: { label: 'Substance misuse', icon: '🤝' },
  delivery: { label: 'Delivery', icon: '🚚' },
  wheelchair_access: { label: 'Wheelchair access', icon: '♿️' },
  private_consultations: { label: 'Private consultations', icon: '🔒' },
};
