...
static const CGFloat DEFAULT_TITLE_FONT_SIZE = 17.0;
static const CGFloat DEFAULT_TITLE_LARGE_FONT_SIZE = 34.0;
                                    ...
                                    withConfig:(RNSScreenStackHeaderConfig *)config API_AVAILABLE(ios(13.0))
{
  ...
  if (config.titleFontFamily || config.titleFontSize || config.titleFontWeight || config.titleColor) {
    ...
    NSString *family = config.titleFontFamily ?: nil;
      CGFloat size = config.titleFontSize != nil ? [config.titleFontSize floatValue] : DEFAULT_TITLE_FONT_SIZE;
      ...
      if (family || weight) {
        attrs[NSFontAttributeName] = [RCTFont updateFont:nil
                                              withFamily:config.titleFontFamily
                                                    size:@(size)  // Wrap CGFloat back into NSNumber
                                                  weight:weight
                                                   style:nil
                                                 variant:nil
                                         scaleMultiplier:1.0];
  ...
  if (config.largeTitleFontFamily || config.largeTitleFontSize || config.largeTitleFontWeight ||
    ...
    NSString *largeFamily = config.largeTitleFontFamily ?: nil;
      CGFloat largeSize = config.largeTitleFontSize ? config.largeTitleFontSize.doubleValue : DEFAULT_TITLE_LARGE_FONT_SIZE;
    ...
    if (largeFamily || largeWeight) {
      largeAttrs[NSFontAttributeName] = [RCTFont updateFont:nil
        ...
        largeAttrs[NSFontAttributeName] = [UIFont systemFontOfSize:largeSize weight:UIFontWeightBold];
    }
