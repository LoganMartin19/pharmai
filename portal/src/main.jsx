...
function Settings({profile}) { return <section className="grid"><div className="panel wide"><h2>Branches and team</h2><div className="branch-list"><div><span className="branch-icon">HS</span><div><strong>High Street Branch</strong><small>Open · 08:30–18:00 · 4 team members</small></div><Badge>active</Badge></div><div><span className="branch-icon">PP</span><div><strong>PharmAI Pilot Pharmacy</strong><small>Open · 09:00–17:30 · 3 team members</small></div><Badge>active</Badge></div></div></div><div className="panel"><h2>Security controls</h2><ul className="checks"><li>Role-based access</li><li>Consent-scoped patient data</li><li>Audited pharmacy actions</li><li>Server-side administration</li></ul><p className="muted">Organisation: {profile.orgName}<br/>Your role: {profile.role}</p></div></section>; }
